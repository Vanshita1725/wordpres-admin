        ...
        <div className="flex flex-row">
          ...
          <div className="flex-1 mt-10 bg-gray-100 border border-[#e5e7eb] rounded shadow-sm p-8">
            ...
            <form className="space-y-10">
              ...
              <div>
                <div className="font-semibold mb-2 text-base">Other comment settings</div>
                <div className="space-y-2 ml-1">
              ...
              <Section title="Comment Pagination">
                ...
                <div className="ml-6">
                  ...
                  <Input type="number" min={1} className="bg-white" />
                </div>
                <div className="ml-6">
                  <Label text="Comments page to display by default" />
                  <Select options={['Last page', 'First page']} className="bg-white" />
                </div>
                <div className="ml-6">
                  <Label text="Comments to display at the top of each page" />
                  <Select options={['Older', 'Newer']} className="bg-white" />
                </div>
              </Section>
...
const Input = ({ type = 'text', min, value, className = '' }) => (
  <input
    type={type}
    min={min}
    defaultValue={value}
    className={`w-24 border rounded px-2 py-1 ${className}`}
  />
);
...
const Select = ({ options, selected, className = '' }) => (
  <select className={`border rounded px-2 py-1 ${className}`} defaultValue={selected}>
    {options.map(opt => (
