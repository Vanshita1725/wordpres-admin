...
const JeneralSettings = () => {
  ...
  return (
     <div>
      <Header />     
      <main className="flex flex-col mx-auto bg-[#f6f7f7] min-h-screen p-0">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <button
                    type="submit"
                    className="bg-[#0073aa] hover:bg-[#005a87] text-white px-6 py-2 rounded font-semibold text-lg"
                  >
                    Save Changes
                  </button>
                </div>
...
export default JeneralSettings;